...
<div class="main-content">
    <div class="container-fluid pt-4 px-4">
        <form class="row g-4 mb-3" action="<?= url_to('ProductController::update',$id);?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-12 text-center d-flex">
                <div class="ms-2">
                    <label for="img" class="position-relative">
                        ...
                        <img
                            src="<?= base_url();?>public/img/<?php if($data['img']!==null && $data['img']!==''){echo $data['img'];}else{echo 'product.jpg';}?>"
                            alt="Photo"
                            style="width: 160px; height:160px; object-fit: contain"
                            id="userImgTag"
                            onerror="this.onerror=null; this.src='<?= base_url();?>public/img/product.jpg';"
                        />                      
                    </label>
